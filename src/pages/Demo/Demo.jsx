          ...
          <div className=" w-[80%] lg:w-full basis-[45%] gap-5   text-white  flex flex-col justify-center items-start p-5">
            ...
            <ul className="flex flex-col text-xl gap-4 ">
              <li>
                ...
                Gain deeper insights into the job applicant’s skills. Shortlist
                only the job fit candidates for subsequent interview.{" "}
              </li>
              <li>
                <i
                  className="fas fa-check-square"
              ...
              <li>
                ...
                <br />
                Choose Pre-built Tests for over 800+ Skills and 1200+ Job roles.
                Alternatively, customize assessments for your organization and
                usecase.
              </li>
            </ul>
            </div>
          ...
          <div className=" w-[80%] lg:w-full flex flex-col basis-[45%]  md:min-w-[500px] p-8 bg-white  rounded-md shadow-md">
            <form onSubmit={handleSubmit} className=" contact-form flex flex-col gap-5">
              <div className=" flex flex-col gap-2 items-start ">
                <label>I'm Looking at a solution for: <span className="text-red-500">*</span> </label>
                <div className="   ">
                  <input type="radio" name="usertype" checked={formData.usertype==="myself"} onChange={handleChange} value="myself" /> Myself{" "}
                  <br />
                  <input type="radio" name="usertype" checked={formData.usertype==="organization"} onChange={handleChange} value="organization" /> My
                  Organization
                </div>
              </div>
              <div className="flex flex-col md:flex-row  gap-5 md:gap-16">
                ...
                <div className="flex flex-col">
                  ...
                  <input type="email" name="email" placeholder="name@yahoo.com" onChange={handleChange} value={formData.email} required />
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-5 md:gap-16">
                <div className="flex flex-col">
                  ...
                  <input type="text" name="company" placeholder="company name" onChange={handleChange} value={formData.company} required />
                </div>
                <div className="flex flex-col">
              ...
              <div className="flex flex-col gap-2">
                <label>Which team do you belong to? <span className="text-red-500">*</span> </label>
                <select name="team" className="py-2 w-[75%] lg:w-full" onChange={handleChange} value={formData.team}  required>
                  <option disabled   value="">Please Select</option>
                  <option  value="Management">Management (CXO,SVP,VP,Head)</option>
              ...
              <div className="">
                <label className="">I'd specifically like to look at <span className="text-red-500">*</span> </label>
