    ...
    <section>
        <div className="flex   h-auto w-full ">
            <div  className="left flex flex-col px-5 md:px-20 lg:px-0  lg:w-[53%] justify-center items-center pb-[24px] gap-5  ">
                <h1 className="text-[#3C403D] md:w-[750px] lg:w-[550px]  text-[40px] md:text-[45px] font-bold leading-[1]  mt-[25px] "><span className="text-xobin_blue">Automated Video Interviews :</span> Assess with precision, decide with confidence.</h1>
                <p className="text-[#565656] md:w-[750px] lg:w-[550px] text-lg md:text-xl ">You’ll never have to worry about scheduling telephone screening rounds again. Give all candidates an opportunity to shine with on-demand and automated video interviews.</p>
